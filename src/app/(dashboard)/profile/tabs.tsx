...
export default function Page({ usero }) {
    ...
    return (<>
        <div className="ml-10">
            <a className="mx-2 text-sm font-semibold text-indigo-700" onClick={() => {
                setActiveTab(1)
            }} >Projects</a>
            {usero.role === "admin" && (
                <a className="mx-2 text-sm font-semibold text-gray-600 hover:text-indigo-700" onClick={() => {
                    setActiveTab(2)
                }}>Team</a>)}
        </div>
...

        {
            activeTab === 2 && (
                <div>
                    {directors.map(function (data: any, key: any) {
                        return (
                            <div key={key}>
                                User: {data.username}
                            </div>
