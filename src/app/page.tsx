      ...
      ctxRef.current = gsap.context(() => {
        ...
        if (screenWidth > 1000) {
          ...
          scrollassist0.to(
            ...
            backgroundColor: "#EAEDFE", duration: 0.5
          }, "<");;
          ...
          scrollassist1.to(
            ...
            backgroundColor: "#FFF5D8", duration: 0.5
          }, "<");
          ...
          <div className="slider-container" id="slider-id">
            ...
            <div id="section-2" className="full-screen panels">
              <div className="akaar-wedstyle">
                <h1 id="akaar-wed-shadow-1" style={{ color: "#E5E1D4" }}>WEDDINGS</h1>
              </div>
              <div className="akaar-wedstyle">
                <h1 id="akaar-wed-shadow" style={{ color: "#B2AFA5" }}>WEDDINGS</h1>
              </div>
              <div className="akaar-wedstyle" style={{ overflow: "hidden", backgroundColor: "#FFFFFF" }}>
            ...
            <div id="section-3" className="full-screen panels">
              <div className="akaar-wedstyle">
                <h1 id="akaar-fashion-shadow-1" style={{ color: "#E5E1D4", }}>FASHION</h1>
              </div>
              <div className="akaar-wedstyle">
                <h1 id="akaar-fashion-shadow" style={{ color: "#B2AFA5", }}>FASHION</h1>
              </div>
              <div className="akaar-wedstyle" style={{ overflow: "hidden", backgroundColor: "#FFFFFF" }}>
            ...
            <div id="section-4" className="full-screen panels">
              <div className="akaar-wedstyle">
                <h1 id="akaar-commercials-shadow-1" style={{ color: "#E5E1D4" }}>COMMERCIALS</h1>
              </div>
              <div className="akaar-wedstyle">
                <h1 id="akaar-commercials-shadow" style={{ color: "#B2AFA5" }}>COMMERCIALS</h1>
              </div>
              <div className="akaar-wedstyle" style={{ overflow: "hidden", backgroundColor: "#FFFFFF" }}>
