        ...
        if (pageloaded) {
            ...
            ctxRef.current = gsap.context(() => {
                ...
                if (screenWidth > 1000) {
                    ...
                    // lamps(scrolltween, "#section-2 #cealling-lamp", ["#section-2 #cealling-lamp #Group_2"])
                    // lamps(scrolltween, "#section-3 #cealling-lamp", ["#section-3 #cealling-lamp #Group_2"])
                    // lamps(scrolltween, "#section-4 #cealling-lamp", ["#section-4 #cealling-lamp #Group_2"])
    ...
    const lamps = (scrolltween, trigger, targets) => {
        ...
        function lamps2() {
            ...
            t.to(targets[1], {
                ...
                rotation: -3, duration: 1.8, ease: "sine.inOut"
            }).to(targets[1], {
                rotation: 0, duration: 1.5, ease: "sine.inOut"
            })
                    ...
                    <div className="slider-container" id="slider-id">
                        ...
                        <div id="section-2" className="full-screen panels">
                            ...
                            <div id="cealling-lamp">
                                <svg viewBox="0 0 188 266" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="Lamp_2">
                                        <g id="Group">
                                            <g id="Group_2">
