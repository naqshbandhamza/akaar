                                    ...
                                    <g id="Lamp_2">
                                        <g id="Group">
                                            <g id="Group_2">
                                                ...
                                                <path id="Vector_2" opacity="0.3" d="M55.294 242.546C75.5838 242.546 92.032 226.098 92.032 205.808C92.032 185.518 75.5838 169.07 55.294 169.07C35.0042 169.07 18.556 185.518 18.556 205.808C18.556 226.098 35.0042 242.546 55.294 242.546Z" fill="#5B8C91" />
                                                <g id="Group_3">
                                                    <g id="Group_4">
                                                        <g id="Group_5">
                                                            <g id="Group_6">
                                                ...
                                                <path id="Vector_19" opacity="0.5" d="M73.933 164.888L38.023 164.299C21.488 171.097 9.84499 187.365 9.84499 206.351C9.84499 231.452 30.193 251.8 55.294 251.8C80.395 251.8 100.743 231.452 100.743 206.351C100.743 187.893 89.739 172.005 73.933 164.888Z" fill="#5B8C91" />
                                                <g id="Group_10" opacity="0.2">
